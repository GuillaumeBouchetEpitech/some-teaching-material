...
const myWholeNumber1 = 111;
const myWholeNumber2 = 0;
const myWholeNumber3 = -33;

const myDecimalNumber1 = 222.33;
const myDecimalNumber2 = 0.0;
const myDecimalNumber3 = -0.003;
...
const myStarString = "BONjour";
const myLowerCaseString = myStarString.toLowerCase(); // -> bonjour
const myUpperCaseString = myStarString.toUpperCase(); // -> BONJOUR
